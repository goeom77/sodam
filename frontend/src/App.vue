<template>
      ...
      <div style="text-align: start;">
        ...
        <div v-if="isLogin===true">
          ...
          <div class="ml-5">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                 class="bi bi-door-open-fill" viewBox="0 0 16 16" @click="logOut" type="button">
              <path
          ...
          <hr>
          <!-- 개인정보 수정 -->
          <router-link to="/CheckEditInformation" style="text-decoration: none ;" class="ml-5" type="button"
                       @click="dialogoff">
        ...
        <div v-if="isLogin===false" class="mt-3">
          <router-link to="/login" style="text-decoration: none ;" class="ml-5" type="button" @click="dialogoff">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-door-open"
                 viewBox="0 0 16 16" @click="logIn">
  ...
  <v-container id="fh5co-page">
    <v-container id="fh5co-aside" role="complementary"
                 class="border js-fullheight d-flex justify-center align-center mb-6 bg-surface-variant"
                 style="width: 15%">
      <a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle"><i></i></a>
      <v-container>
        <nav id="fh5co-main-menu" role="navigation" class="mx-auto">
